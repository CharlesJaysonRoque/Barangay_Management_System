...
<div class="create-container">
    <div class="create-card">
        <div class="create-header">
            ...
            <div>
                <h1 class="create-title">File a Complaint</h1>
                <p class="create-subtitle">Record a new complaint in the barangay</p>
            </div>
        </div>

        <form action="{{ route('complaint_details.store') }}" method="POST" class="create-form">
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="accused_id" class="form-select" required>
                    ...
                    @foreach($residents as $resident)
                        <option value="{{ $resident->id }}" {{ old('accused_id') == $resident->id ? 'selected' : '' }}>
                            {{ $resident->lastname }}, {{ $resident->firstname }}
                            @if($resident->email) - {{ $resident->email }} @endif
                        </option>
                    @endforeach
