...
<div class="index-container">
    ...
    <div class="index-header">
        <div>
            <h1 class="index-title">Fines Management</h1>
            <p class="index-subtitle">Manage barangay fine amounts and penalties</p>
        </div>
        <a href="{{ route('fines.create') }}" class="btn-create">
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value">₱{{ number_format($fines->sum('amount'), 0) }}</div>
        ...
        <div class="stat-card">
            ...
            <div>
                <div class="stat-value">₱{{ number_format($fines->avg('amount'), 2) }}</div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="actions-container">
                            <a href="{{ route('fines.edit', $fine->id) }}" class="action-btn edit-btn" title="Edit">
                ...
                <tr>
                    <td colspan="4" class="empty-state">
                        ...
                        <p>No fines found</p>
                        <a href="{{ route('fines.create') }}" class="btn-create-sm">Add your first fine</a>
                    </td>
                </tr>
                @endforelse
            </tbody>
